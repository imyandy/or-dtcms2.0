...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 下载管理 &gt; 管理列表</div>
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <a href="edit.aspx?action=<%=DTEnums.ActionEnum.Add %>&channel_id=<%=this.channel_id %>" class="tools_btn"><span><b class="add">添加下载</b></span></a>
