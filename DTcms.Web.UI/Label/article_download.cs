    ...
    public partial class BasePage : System.Web.UI.Page
    {
        ...
        protected DataTable get_download_list(int channel_id, int category_id, int top, string strwhere)
        {
            ...
            if (channel_id > 0)
            {
                ...
                dt = new BLL.article().GetDownloadList(top, _where, "sort_id asc,add_time desc").Tables[0];
            }
            return dt;
        }
        ...
        protected DataTable get_download_list(int channel_id, int category_id, int top, string strwhere, string orderby)
        {
            ...
            if (channel_id > 0)
            {
                ...
                dt = new BLL.article().GetDownloadList(top, _where, orderby).Tables[0];
            }
            return dt;
        }
        ...
        protected DataTable get_download_list(int channel_id, int category_id, int page_size, int page_index, string strwhere, out int totalcount)
        {
            ...
            if (channel_id > 0)
            {
                ...
                dt = new BLL.article().GetDownloadList(page_size, page_index, _where, "sort_id asc,add_time desc", out totalcount).Tables[0];
            }
            else
            {
                totalcount = 0;
