...
<div id="contentTab">
    ...
    <div class="tab_con" style="display:block;">
        <table class="form_table">
            ...
            <tr>
                <th>生 日：</th>
                <td><asp:TextBox ID="txtBirthday" runat="server" CssClass="txtInput normal dateISO" maxlength="20" onclick="return Calendar('txtBirthday');"></asp:TextBox><label></label></td>
            </tr>
            <tr>
                <th>电 话：</th>
