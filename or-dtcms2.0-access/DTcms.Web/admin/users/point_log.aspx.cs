...
namespace DTcms.Web.admin.users
{
    public partial class point_log : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("point_log", DTEnums.ActionEnum.View.ToString()); //检查权限
        ...
        {
            ChkAdminLevel("point_log", DTEnums.ActionEnum.Delete.ToString()); //检查权限
            BLL.point_log bll = new BLL.point_log();
            ...
            JscriptMsg("批量删除成功啦！", Utils.CombUrlTxt("point_log.aspx", "keywords={0}", this.keywords), "Success");
        }
