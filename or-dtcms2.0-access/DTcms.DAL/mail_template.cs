...
namespace DTcms.DAL
{
    ...
    public partial class mail_template
    {
        ...
        {
            string strSql = "select top 1 id from dt_mail_template order by id desc";
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from dt_mail_template");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(0) from dt_mail_template");
        ...
        public int Add(Model.mail_template model)
        {
            ...
            using (OleDbConnection conn = new OleDbConnection(DbHelperOleDb.connectionString))
            {
                ...
                using (OleDbTransaction trans = conn.BeginTransaction())
                {
                    ...
                    {
                        StringBuilder strSql = new StringBuilder();
                        strSql.Append("insert into dt_mail_template(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update dt_mail_template set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from dt_mail_template ");
            strSql.Append(" where id=@id");
            OleDbParameter[] parameters = {
					new OleDbParameter("@id", OleDbType.Integer,4)};
            parameters[0].Value = id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 id from dt_mail_template");
            strSql.Append(" where call_index=@call_index");
            OleDbParameter[] parameters = {
					new OleDbParameter("@call_index", OleDbType.VarChar,50)};
            parameters[0].Value = call_index;
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" FROM dt_mail_template ");
            if (strWhere.Trim() != "")
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM dt_mail_template");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
