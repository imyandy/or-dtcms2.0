...
namespace DTcms.DAL
{
    ...
    public partial class distribution
    {
        ...
        {
            string strSql = "select top 1 id from dt_distribution order by id desc";
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from dt_distribution");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 title from dt_distribution");
            strSql.Append(" where id=" + id);
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from dt_distribution ");
            strSql.Append(" where id=@id");
            OleDbParameter[] parameters = {
					new OleDbParameter("@id", OleDbType.Integer,4)
			};
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,title,remark,[type],amount,sort_id,is_lock ");
            strSql.Append(" FROM dt_distribution ");
            if (strWhere.Trim() != "")
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM dt_distribution");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
