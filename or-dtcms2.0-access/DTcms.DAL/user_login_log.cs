...
namespace DTcms.DAL
{
	...
	public partial class user_login_log
	{
        ...
        {
            string strSql = "select top 1 id from dt_user_login_log order by id desc";
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from dt_user_login_log");
		...
		public int Add(Model.user_login_log model)
		{
            ...
            using (OleDbConnection conn = new OleDbConnection(DbHelperOleDb.connectionString))
            {
                ...
                using (OleDbTransaction trans = conn.BeginTransaction())
                {
                    ...
                    {
			            StringBuilder strSql=new StringBuilder();
			            strSql.Append("insert into dt_user_login_log(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,user_id,user_name,remark,login_time,login_ip from dt_user_login_log ");
            strSql.Append(" where id=@id");
            OleDbParameter[] parameters = {
					new OleDbParameter("@id", OleDbType.Integer,4)};
            parameters[0].Value = id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id from dt_user_login_log");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" FROM dt_user_login_log ");
			if(strWhere.Trim()!="")
			{
