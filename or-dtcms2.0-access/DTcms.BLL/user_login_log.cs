...
namespace DTcms.BLL
{
    ...
    {
        private readonly DAL.user_login_log dal = new DAL.user_login_log();
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(int user_id, string user_name, string remark, string getip)
        {
            Model.user_login_log model = new Model.user_login_log();
            model.user_id = user_id;
            model.user_name = user_name;
            model.remark = remark;
            model.login_ip = getip;
